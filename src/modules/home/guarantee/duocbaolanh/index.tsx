...
function Guaranteed({ display }: any) {
    ...
    return (
        <div style={{ backgroundColor: 'rgb(239, 248, 255)' }}>
            <div className='SECTION5' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '3% 8% 0 8%' }}>
                <Row>
                    <Col lg={{ span: 24, offset: 0 }} md={{ span: 20, offset: 2 }}>
                        {
                            titleTransition((style, item) => (
                                <animated.div style={style}>
                                    ...
                                    <Title level={5} style={{ textAlign: 'center' }}>Doanh nghiệp bên được bảo lãnh</Title>
                                </animated.div>
                            ))
                        }
                    </Col>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            {
                                imgTransition((style, item) => (
                                    <animated.div style={style}>
                                        <Image preview={false} style={{ width: '100%', height: 'auto', display: 'block', margin: 'auto', minWidth: '420px' }} src='/images/home/Guarantee/frame-427319352-20231001061612-d4dqg-vi.png' />
                                    </animated.div>
                                ))
                            }
                        </div>
